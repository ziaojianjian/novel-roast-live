...
import { calculateFangyuanIndex, grade } from '../src/scoring.js';
...
test('Fangyuan grades use engaging live copy',()=>{assert.equal(grade(4.1),'破局在即');assert.equal(grade(5),'锋芒毕露');});
